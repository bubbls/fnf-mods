...
function onCreate()
	...
	makeLuaSprite('lefthall', 'stage/bite/llight');
	addLuaSprite('lefthall');
	setProperty('lefthall.alpha',0);

	makeLuaSprite('righthall', 'stage/bite/rlight');
	addLuaSprite('righthall');
	setProperty('righthall.alpha',0);

	makeLuaSprite('doorL', 'stage/bite/door',0,-1500);
	addLuaSprite('doorL');
	scaleObject('doorL',2,2,true);

	makeLuaSprite('doorR', 'stage/bite/door',0,-1500);
	addLuaSprite('doorR');
	...
	makeLuaSprite("newspaper", 'stage/bite/news', 0, 0);
	setGraphicSize("newspaper", 'FlxG.width*2', 'FlxG.height*2', true);
	addLuaSprite("newspaper",true);
	setLuaSpriteScrollFactor("newspaper", 0.0, 0.0);
	screenCenter("newspaper", 'xy');


	makeLuaSprite("titlescreen", 'stage/bite/bitetitle', 0, 0);
	setGraphicSize("titlescreen", 'FlxG.width*2', 'FlxG.height*2', true);
	...
	setGraphicSize("static", 'FlxG.width*2', 'FlxG.height*2', true);
...
function onCreatePost()
	...
	makeLuaSprite('barup', 'stage/bite/bdup', 0, 0)
	setGraphicSize("barup", screenWidth*2, 0, true)
	addLuaSprite('barup',true)

	makeLuaSprite('bardown', 'stage/bite/bddown', 0, 100)
	...
	makeLuaSprite('fx', 'stage/bite/overlay', 0, 0)
	addLuaSprite('fx')
	...
	makeLuaSprite("youtubebuttons", 'stage/bite/play', 15, getProperty('timeBar.y') + 12)
	...
	for i = 1,5 do
		makeLuaSprite("stars"..i, 'stage/bite/stars', 910 + (i*30), getProperty('timeBar.y') + 12)
	...
	makeAnimatedLuaSprite("loadcircle", 'stage/bite/load')
